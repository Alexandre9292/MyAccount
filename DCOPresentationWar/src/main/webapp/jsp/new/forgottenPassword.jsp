		...
		<section class="main">
			<div class="page-header">
				...
				<div class="container">
					...
					<form:form methode="post" action="resetPassword" id="formAccount">
						<spring:message code="page.formulaire.web.message.home.email" var="email"/>
						<ul class="fields-list x2">
							<li><input type="text" id="email" name="email" iplaceholder="${email}"></li>
							<li><button type="submit" value="Create"><spring:message code="page.formulaire.web.message.home.resetPassword" /></button></li>
						</ul>
					</form:form>
				</div>
