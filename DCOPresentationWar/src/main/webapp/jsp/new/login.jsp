        			...
        			<div class="row">
        				<div class="col-md-9">
        					...
        					<h1 class="main-logo has-sitename">
        						<a href="<%=WebConstants.NEW_LOGIN_LOAD%>"><spring:message code="web.header.bnpp" /></a> 
        						<span class="baseline"><spring:message code="web.header.bank" /></span>
        					</h1>
        				</div>
        				<!-- Core feature sur desktop (3 colonnes)  -->
        				<div class="col-md-3 hidden-xs hidden-sm">
        					<a href="<%=WebConstants.SIGNUP_LOAD%>" class="core-feat">
        						<span><spring:message code="page.formulaire.web.message.home.signup" /></span>
        					</a>
        				</div>
        			</div>
        		</div>
		...
		<section class="main">
			<div class="page-header">
				...
				<div class="container">
					...
					<form:form action="login" id="formAccount" commandName="newLoginForm">
						<ul class="fields-list x3">
							...
							<li><form:input type="text" placeholder="${email}" path="userMail"></form:input></li>
							<li><form:input type="password"  id="password" placeholder="${password}" path="password"></form:input><img src="../../img/new/eye.png" class="bt-password" alt="show/hide password"></li>
							<li><button type="submit" value="Create"><spring:message code="page.formulaire.web.message.home.login" /></button></li>
						</ul>
<%-- 						<form:checkbox name="remember-me" id="remember-me" path="rememberMe"></form:checkbox></input> --%>
<%-- 						<label for="remember-me"><spring:message code="page.formulaire.web.message.home.remember" /></label> --%>
						<a href="<%=WebConstants.NEW_FORGOTTEN_PASSWORD_LOAD%>" class="forgot-link"><spring:message code="page.formulaire.web.message.home.forgottenPassword" /></a>
					</form:form>
				</div>
